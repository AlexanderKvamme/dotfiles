#### NY - KAN MULIGENS SLETTE HELE OG HELLER LAGE SHORTCUTS SLIK: ### FINDER ###

# Tags shortcut
#defaults write com.apple.Finder NSUserKeyEquivalents -dict-add 'Rename' -string '^R' # virker bare i terminal
#defaults write com.apple.Finder NSUserKeyEquivalents -dict-add 'Rename' -string '^~@D' # virker bare i terminal
